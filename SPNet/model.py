...
from SPNet.res2net_v1b_base import Res2Net_model
...
class SPNet(nn.Module):
    def __init__(self, channel=32,ind=50):
        ...
        #Backbone model
        #Backbone model
        self.layer_rgb  = Res2Net_model(ind) # 默认使用resnet50 的backbone
    ...
    def forward(self, imgs, depths):
        ...
        dep_0, dep_1, dep_2, dep_3, dep_4 = self.layer_dep(self.layer_dep0(depths)) # 先将depth 转为三通道
